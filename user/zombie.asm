...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	855a                	mv	a0,s6
 4be:	e89ff0ef          	jal	ra,346 <printint>
 4c2:	8bca                	mv	s7,s2
      state = 0;
 4c4:	4981                	li	s3,0
 ...
 4e0:	85d6                	mv	a1,s5
 4e2:	855a                	mv	a0,s6
 4e4:	e45ff0ef          	jal	ra,328 <putc>
        putc(fd, c0);
 4e8:	85ca                	mv	a1,s2
 4ea:	855a                	mv	a0,s6
 4ec:	e3dff0ef          	jal	ra,328 <putc>
      state = 0;
 4f0:	4981                	li	s3,0
 ...
 500:	855a                	mv	a0,s6
 502:	e45ff0ef          	jal	ra,346 <printint>
        i += 1;
 ...
 52a:	855a                	mv	a0,s6
 52c:	e1bff0ef          	jal	ra,346 <printint>
        i += 2;
 ...
 544:	855a                	mv	a0,s6
 546:	e01ff0ef          	jal	ra,346 <printint>
        i += 2;
 ...
 55e:	855a                	mv	a0,s6
 560:	de7ff0ef          	jal	ra,346 <printint>
 564:	8bca                	mv	s7,s2
      state = 0;
 566:	4981                	li	s3,0
 ...
 576:	855a                	mv	a0,s6
 578:	dcfff0ef          	jal	ra,346 <printint>
        i += 1;
 ...
 590:	855a                	mv	a0,s6
 592:	db5ff0ef          	jal	ra,346 <printint>
        i += 2;
 ...
 5aa:	855a                	mv	a0,s6
 5ac:	d9bff0ef          	jal	ra,346 <printint>
 5b0:	8bca                	mv	s7,s2
      state = 0;
 5b2:	4981                	li	s3,0
 ...
 5c2:	855a                	mv	a0,s6
 5c4:	d83ff0ef          	jal	ra,346 <printint>
        i += 1;
 ...
 5e0:	855a                	mv	a0,s6
 5e2:	d47ff0ef          	jal	ra,328 <putc>
  putc(fd, 'x');
 5e6:	07800593          	li	a1,120
 5ea:	855a                	mv	a0,s6
 5ec:	d3dff0ef          	jal	ra,328 <putc>
 5f0:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 63c:	1f890913          	addi	s2,s2,504 # 830 <malloc+0xe8>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 7fc:	ecbff0ef          	jal	ra,6c6 <free>
  return freep;
 800:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 804:	dd61                	beqz	a0,7dc <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 806:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 808:	4798                	lw	a4,8(a5)
 80a:	fa9777e3          	bgeu	a4,s1,7b8 <malloc+0x70>
    if(p == freep)
 80e:	00093703          	ld	a4,0(s2)
 812:	853e                	mv	a0,a5
 814:	fef719e3          	bne	a4,a5,806 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 818:	8552                	mv	a0,s4
 81a:	af7ff0ef          	jal	ra,310 <sbrk>
  if(p == (char*)-1)
 81e:	fd551ce3          	bne	a0,s5,7f6 <malloc+0xae>
        return 0;
 822:	4501                	li	a0,0
 824:	bf65                	j	7dc <malloc+0x94>
